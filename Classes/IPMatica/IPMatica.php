...
namespace Classes\IPMatica;

use Classes\Supplier;
use Classes\Logger;
use \SimpleXMLElement;

class IPMatica extends Supplier
{
    public $articuls = [];
    public $new_product = [];
    ...
    private $settings = [
        ...
        'logPring' => true,
        'source' => [
            'url' => 'https://www.ipmatika.ru/bitrix/catalog_export/price_xml_kz.php',
            'files' => [
                'import' => 'import.xml', 
            ],
            'dir' => __DIR__ . '/files/',
